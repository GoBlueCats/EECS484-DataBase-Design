...
(function(){
    $(function(){
        ...
        if(window.quickReplyflag) {
            ...
            var float_ask_img="<div data-mod='popu_64' class='csdn-tracking-statistics' chg-blk='0' ><a id='com-quick-reply'  title='快速回复' style='top:"+(back_top_value-38)+"px'></a><a id='com-d-top-a'  style='top:"+back_top_value+"px' title='返回顶部' onclick='' ></a> </div>";
