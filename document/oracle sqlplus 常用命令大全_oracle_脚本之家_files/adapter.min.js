            ...
            fnGetBeConfig(config.api, feConfig.appid, function(beConfig) {
                ...
                if (feConfig.ismobile) {
                    ...
                    var initData = function() {
                        ...
                        feConfig.uri = {
                            res: "http://changyan.itc.cn/upload/mobile/v2/",
                    ...
                    if (mobile_code_version === "v2") {
                        ...
                        oldConfig.uri.res = "http://changyan.itc.cn/upload/mobile/v2/";
                    ...
                    if (mobile_code_version === "v1") {
                        ...
                        if (isNewVersion) {
                            ...
                            oldConfig.uri.res = "http://changyan.itc.cn/upload/mobile/v1/";
                        }
                        $$util.loadJs(oldConfig.uri.res + "wap-js/src/init-build.js?" + oldConfig.version);
                        return;
                    }
                    if (mobile_code_version === "v0") {
                        ...
                        if (isNewVersion) {
                            ...
                            oldConfig.uri.res = "http://changyan.itc.cn/upload/mobile/";
                        }
                        $$util.loadJs(oldConfig.uri.res + "wap-js/src/init-build.js?" + oldConfig.version);
                        return;
                    }
